...
public interface IModelSchemaParser<ModelTYPE> {
	 ...
	 */
	public Map<String,ModelSchema<ModelTYPE>> parseModels(InputStream input);
	 ...
	 * @return (non-null) a map of model schemas as referenced by their names.
	 */
	public Map<String,ModelSchema<ModelTYPE>> parseModels(String input);
}
